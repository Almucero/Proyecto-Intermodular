...
async function seedData() {
  try {
    ...
    const genreNames = [
      ...
      "Beat 'Em Up",
      "Novela Visual",
      "Juego de Cartas Coleccionables Digitales (CCG)",
      "FPS",
      "Táctico",
      "Ciencia Ficción",
      "Educativo",
    ...
    const gamesData = [
      ...
      },
      {
        ...
        genres: ["Accion", "Shooter (Disparos)", "FPS"],
      ...
      },
      {
        ...
        genres: ["Acción-Aventura", "Sandbox", "Shooter (Disparos)", "Accion"],
        platforms: ["PC", "PS4", "Xbox One", "PS5", "Xbox Series X"],
        rating: 4.9,
      ...
      },
      {
        ...
        genres: ["RPG", "Shooter (Disparos)", "Acción-Aventura", "Aventura"],
        platforms: ["PC", "PS4", "Xbox One", "PS5", "Xbox Series X"],
        rating: 4.5,
      ...
      },
      {
        ...
        developer: "CD Projekt Red",
        publisher: "CD Projekt",
        genres: ["RPG", "Shooter (Disparos)", "Sandbox", "Acción-Aventura"],
        platforms: ["PC", "PS5", "Xbox Series X", "PS4", "Xbox One"],
        rating: 3.8,
      ...
      },
      {
        ...
        publisher: "2K Games",
        genres: ["Estrategia", "Estrategia por Turnos (TBS)", "Simulacion"],
      ...
      },
      {
        ...
        genres: ["Estrategia", "Estrategia en Tiempo Real (RTS)", "Simulacion"],
      ...
      },
      {
        ...
        developer: "Relic Entertainment",
        publisher: "SEGA",
        genres: ["Estrategia", "Estrategia en Tiempo Real (RTS)"],
        platforms: ["PC"],
        rating: 4.0,
        numberOfSales: 180000,
        stock: 2,
      ...
      },
      {
        ...
        developer: "Blue Byte",
        publisher: "Ubisoft",
        genres: ["Estrategia", "Simulacion", "Estrategia en Tiempo Real (RTS)"],
        platforms: ["PC", "PS5", "Xbox Series X"],
        rating: 4.1,
      ...
      },
      {
        ...
        developer: "Creative Assembly",
        publisher: "SEGA",
        genres: ["Terror (Survival Horror)", "Stealth", "Ciencia Ficción"],
      ...
      },
      {
        ...
        publisher: "Bethesda Softworks",
        genres: ["Terror (Survival Horror)", "Accion", "Horror Psicológico"],
        platforms: ["PC", "PS4", "Xbox One", "PS3", "Xbox 360"],
        rating: 3.9,
      ...
      },
      {
        ...
        publisher: "Sony Interactive Entertainment",
        genres: ["Terror (Survival Horror)", "Aventura", "Cinemático"],
        platforms: ["PS4", "PS5"],
        rating: 4.1,
      ...
      },
      {
        ...
        genres: ["Terror (Horror Psicológico)", "Aventura", "Narrativa"],
        platforms: ["PC", "PS4", "Xbox One", "Switch", "PS5", "Xbox Series X"],
        rating: 3.7,
        numberOfSales: 75000,
        stock: 2,
      ...
      },
      {
        ...
        publisher: "Electronic Arts",
        genres: ["Terror (Survival Horror)", "Ciencia Ficción", "Accion"],
        platforms: ["PC", "PS5", "Xbox Series X"],
        rating: 4.0,
        numberOfSales: 160000,
        stock: 657,
      ...
      },
      {
        ...
        genres: ["Terror (Survival Horror)", "Cooperativo", "Simulacion"],
        platforms: ["PC", "VR"],
        rating: 4.2,
