/**
 * @file: src/backend/modules/favorites/favorites.routes.ts
 * @project: GameSage - Plataforma de Videojuegos
 * @authors: Rosario González y Álvaro Jiménez
 * @description: Definición de rutas de favoritos con endpoints para CRUD, validación (Zod) y autenticación.
 */
