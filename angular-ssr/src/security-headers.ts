...
export function applySecurityHeaders(
  ...
  let csp =
    ...
    "frame-src 'self' https://www.youtube.com https://www.youtube-nocookie.com https://js.stripe.com https://hooks.stripe.com https://accounts.google.com; " +
  ...
  if (isProduction) {
    ...
    csp +=
      "connect-src 'self' https://res.cloudinary.com https://generativelanguage.googleapis.com https://api.stripe.com https://r.stripe.com https://m.stripe.network https://js.stripe.com https://hooks.stripe.com https://accounts.google.com https://accounts.gstatic.com https://cdnjs.cloudflare.com https://cdn.jsdelivr.net https://api.mymemory.translated.net https://github.githubassets.com; ";
    ...
    csp +=
      "connect-src 'self' ws://localhost:* http://localhost:* https://res.cloudinary.com https://generativelanguage.googleapis.com https://api.stripe.com https://r.stripe.com https://m.stripe.network https://js.stripe.com https://hooks.stripe.com https://accounts.google.com https://accounts.gstatic.com https://cdnjs.cloudflare.com https://cdn.jsdelivr.net https://api.mymemory.translated.net https://github.githubassets.com; ";
  }
