...
export interface User extends Model {
  ...
  /** País de residencia. */
  country?: string | null;
  /** Permite desactivar todos los correos no críticos. */
  emailNotificationsEnabled?: boolean;
  /** Email destino para notificaciones (si es distinto del principal). */
  notificationEmail?: string | null;
  /** Idioma preferido para los correos. */
  emailNotificationLanguage?: string | null;
  /** Frecuencia de envío para comunicaciones no urgentes. */
  emailNotificationFrequency?: 'immediate' | 'daily' | 'weekly' | null;
  /** Catálogo de categorías de email activas por usuario. */
  emailNotificationTopics?: Record<string, boolean> | null;
  /** Fecha hasta la que se silencian correos no críticos. */
  emailNotificationPausedUntil?: string | Date | null;
  /** Inicio de la franja silenciosa (0-23). */
  emailQuietHoursStart?: number | null;
  /** Fin de la franja silenciosa (0-23). */
  emailQuietHoursEnd?: number | null;
  /** Intervalo de recomendaciones periódicas en días (mínimo 1). */
  emailRecommendationIntervalDays?: number | null;
